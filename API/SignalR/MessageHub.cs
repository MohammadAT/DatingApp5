...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        private async Task<Group> AddToGroup(string grooupName)
        {
            var group = await _unitOfWork.MessageRepository.GetMessageGroup(grooupName);
            var connection = new Connection(Context.ConnectionId, Context.User.GetUsername());

            if (group == null)
            {
                group = new Group(grooupName);
